...
export function settingsCategories(t: (key: string) => string): SettingsCategory[] {
  return [
    ...
    { key: 'contacts', group: 'accounts', label: t('settingsPanel.category.contacts'), keywords: t('settingsPanel.keywords.contacts'), icon: IconAddressBook, iconName: 'address-book' },
    { key: 'profiles', group: 'accounts', label: t('settingsPanel.category.profiles'), keywords: t('settingsPanel.keywords.profiles'), icon: IconUsers, iconName: 'users' },
